...
const nivethith = {
  ...
  role:       "CS Undergrad @ University of Westminster (IIT Colombo)",
  focus:      ["AI/ML Engineering", "Full Stack Web", "UI/UX"],
  building:   ["NIVI", "NovaStack", "CVForge"],
  learning:   ["PyTorch", "System Design", "LLM Application Engineering"],
  philosophy: "Design it like a product, build it like an engineer.",
  funFact:    "I prototype in Figma before I ever open a terminal.",
};
```
...
- 🔭 &nbsp;Currently building **AI-assisted web products** — Figma wireframe to deployed app
- 🌱 &nbsp;Levelling up in **applied ML**, model deployment, clean architecture
- 🎨 &nbsp;**UI/UX-first background** — I build for humans, not just for the demo
- 💬 &nbsp;Ask me about **React, TypeScript, Firebase, OpenAI APIs, design systems**
- 🤝 &nbsp;Open to **internships, collaborations, open source**
- 📫 &nbsp;Reach me at **niknive7@gmail.com**
...
|:--|:--|:--|
| **[NIVI](https://github.com/Nivethith-AK/NIVI)** ⭐ | `EDIT ME — one line: what problem does it solve?` | `TypeScript` `React` |
| **[NovaStack](https://github.com/Nivethith-AK/novastack)** | `EDIT ME — one line` | `TypeScript` |
| **[CVForge](https://github.com/Nivethith-AK/CVForge)** | `EDIT ME — one line` | `TypeScript` |
...
| | |
|:--|:--|
| 🎓 | **BSc (Hons) Computer Science** — University of Westminster (UK), delivered at **IIT Colombo** |
| 📜 | **Microsoft AI & ML Engineering** Specialization — Coursera |
...
<a href="https://www.linkedin.com/in/nivethith-ak/"><img src="https://img.shields.io/badge/Connect%20on%20LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>
<a href="mailto:niknive7@gmail.com"><img src="https://img.shields.io/badge/Send%20an%20Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email"/></a>
<a href="https://nivethith.vercel.app"><img src="https://img.shields.io/badge/View%20Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white" alt="Portfolio"/></a>
